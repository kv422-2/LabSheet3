...
class DBOperations:
  ...
  pilots_table_population = "INSERT OR IGNORE INTO Pilots (PilotNumber, PilotName) VALUES (1, 'John Doe'),(2, 'Jane Smith'),(3, 'Alice Johnson'),(4, 'Bob Brown'),(5, 'Charlie Davis'),(6, 'Diana Miller'),(7, 'Evan Wilson'),(8, 'Fiona Clark'),(9, 'Guy Gill'),(10, 'Elton John');"
